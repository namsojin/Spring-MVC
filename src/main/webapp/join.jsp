			...
			<div class="inner">
				...
				<section id="banner">
					<div class="content">
						...
						<form method="post" action="join.do">
							<div class="row gtr-uniform">
								<div class="col-6 col-12-xsmall">
									아이디<input type="text" name="mid" placeholder="아이디를 입력하세요." value="" required />
								</div>
							
								<div class="col-6 col-12-xsmall">
									비밀번호<input type="password" name="mpw" placeholder="비밀번호를 입력하세요." value="" required />
								</div>
								
								<div class="col-6 col-12-xsmall">
									이름<input type="text" name="mname" placeholder="이름을 입력하세요." value="" required />
								</div>
								<div class="col-12">
									<ul class="actions">
										<li><input type="submit" value="회원가입하기" class="button big" /></li>
									</ul>
								</div>
							</div>
						</form>
						<div class="col-12">
									<ul class="actions">
										<li><a href="login.do" class="button big">로그인페이지로</a></li>
									</ul>
						</div>
